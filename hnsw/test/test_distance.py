...
class TestDistance(unittest.TestCase):
    ...
    def test_cosine_distance(self):
        ...
        self.assertAlmostEqual(self.distance_cosine.distance(self.node1, self.node2), 1.0)
        
        self.assertAlmostEqual(self.distance_cosine.distance(self.node1, self.node1), 0.0)
        
        self.assertAlmostEqual(self.distance_cosine.distance(self.node1, self.node4), 0.0)
